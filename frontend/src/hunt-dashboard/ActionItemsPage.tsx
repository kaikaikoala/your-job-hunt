    ...
    <Box sx={{ minHeight: '100vh', bgcolor: '#F7F9FB' }}>
      ...
      <Box component="main" sx={{ pt: '80px', px: 4, pb: 6, maxWidth: 860, mx: 'auto' }}>
        ...
        <ToggleButtonGroup
          ...
          sx={{ mb: 3 }}
        >
          <ToggleButton value="open" sx={{ fontFamily: 'Manrope, sans-serif', fontWeight: 600, textTransform: 'none', px: 2 }}>
            Open
          </ToggleButton>
          <ToggleButton value="completed" sx={{ fontFamily: 'Manrope, sans-serif', fontWeight: 600, textTransform: 'none', px: 2 }}>
            Completed
          </ToggleButton>
        </ToggleButtonGroup>
