...
def train():
    ...
    try:
        YourCrew().crew().train(n_iterations=int(sys.argv[1]), filename=sys.argv[2], inputs=inputs)
...
def replay():
    ...
    """
    try:
        YourCrew().crew().replay(task_id=sys.argv[1])
...
def test():
    ...
    try:
        YourCrew().crew().test(n_iterations=int(sys.argv[1]), eval_llm=sys.argv[2], inputs=inputs)
